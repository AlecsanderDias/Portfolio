...
function Tecnologias() {
    return (
        <section id='tecnologias' className='flex flex-col justify-center items-center mx-4 my-4'>
            <h2 className='text-3xl font-bold text-blue-500 mb-4'>Tecnologias</h2>
            <p className='text-xl font-bold text-blue-500'>Linguagens</p>
            ...
            <p className='text-xl font-bold text-blue-500'>Frameworks</p>
            <ul className='flex flex-wrap gap-3 my-6'>

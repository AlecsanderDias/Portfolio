...
function Header() {
    ...
    return (
        <nav className="flex justify-between items-center bg-sky-900 text-white px-3">
            <MoonIcon className="h-6 text-gray-100 block cursor-pointer" />
            <div className="flex justify-center items-center">
                <a href="/#" className="py-3 px-3 hover:bg-sky-800">Sobre Mim</a>
                <a href="/#tecnologias" className="py-3 px-3 hover:bg-sky-800">Tecnologias</a>
                <a href="/#projetos" className="py-3 px-3 hover:bg-sky-800">Projetos</a>
            </div>
